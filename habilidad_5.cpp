#include "habilidad_5.h"

habilidad_5::habilidad_5() : Habilidades("Habilidad_5", 5, 1.5f, 0.5f) // valores inventados de momento, cambiarian a medida que avanza el juego.
{
}
...
void habilidad_5::activar(sf::Vector2f inicio, sf::Vector2f objetivo)
{
	if (_cdListo)
	{
