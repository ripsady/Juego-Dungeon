#include "habilidad_3.h"

habilidad_3::habilidad_3() : Habilidades("Habilidad_3", 5, 1.5f, 0.5f) // valores inventados de momento, cambiarian a medida que avanza el juego.
{
}
...
void habilidad_3::activar(sf::Vector2f inicio, sf::Vector2f objetivo)
{
	if (_cdListo)
	{
