#include "habilidad_4.h"

habilidad_4::habilidad_4() : Habilidades("Habilidad_4", 5, 1.5f, 0.5f) // valores inventados de momento, cambiarian a medida que avanza el juego.
{
}
